...
public class nc_email {
	...
	// 发件人
	private static String from = "jeffsgq1217@gmail.com";

	// 收件人
	private static String to = "jeff.shi@decathlon.com"; //,zhiqiang.ge@decathlon.com,qinglan.xu@decathlon.com,xiao.wang@decathlon.com,qixin.huang@decathlon.com,johnny.wang@decathlon.com,ting.sun2@decathlon.com,ruiheng.ruan@decathlon.com,david.liu2@decathlon.com,kenx.gao@decathlon.com,external.z52mxu@decathlon.com
	...
	public static void realmail(String string, String string2, String string5, String string6) throws Exception {
		// 发送文本邮件
		// sendTextEmail();
...
//		String name4 = string4;
		String exception1 = string5;
		String exception2 = string6;
//		String exception3 = string7;
//		String exception4 = string8;
		//exception1,exception2,exception3,exception4
		sendHtmlWithInnerImageEmail(name1,name2,exception1,exception2);
	 ...
	 * @param name1 
	 */
	//String exception1, String exception2,String exception3, String exception4
	public static void sendHtmlWithInnerImageEmail(String name1, String name2,  String exception1, String exception2) throws MessagingException {
		...
		MimeMessage message = new MimeMessage(session);
		// 邮件主题,并指定编码格式
		message.setSubject("Regression Testing Report "+y+"/"+m+"/"+d+"/"+"-auto mail",
				"utf-8");
		// 发件人
		message.setFrom(new InternetAddress(from));
		// 收件人
		...
		String path = currentPath + "\\Regression_Report.jpg";
		System.out.println(path);
		DataSource ds = new FileDataSource(new File(path));
		DataHandler dh = new DataHandler(ds);
		imagePart.setDataHandler(dh);
		imagePart.setContentID("Regression_Report.jpg"); // 设置内容编号,用于其它邮件体引用
		...
		htmlBodypart
				.setContent(
						"<span style='color:black;'>Hi all,<br> Here is the report of the normal regression test without CNC on "+y+"/"+m+"/"+d+"/"+".<br><br>"
								+name1+"---------"+exception1+"<br>"
								+name2+"---------"+exception2+"<br>"
								+"<br>"
								+"You can find the detail result as below.<br>​"
								+ "--------------------------------------------------------------------------​<br>"
								+ "​It's an auto mail, no need to reply.​<br>​"
								+ "--------------------------------------------------------------------------​<br>"
								+ "Best Regards</span>",
	...
	// * @param message 邮件内容
	// */
	// public static File buildEmlFile(Message message) throws
	...
	static class MyAuthenticator extends Authenticator {
		...
		private String username = "jeffsgq1217";

		private String password = "jeffsgq1002";
